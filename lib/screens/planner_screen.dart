    ...
    return Padding(
      ...
      child: Column(
        children: [
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(_formatTime(_time), style: const TextStyle(fontSize: 14, color: AppColors.textDark)),
                      ],
                    ),
                  ),
                ),
          ...
          const Row(
            children: [
              Icon(Icons.notifications_outlined, size: 13, color: AppColors.textMuted),
              SizedBox(width: 5),
              Text(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (daySessions.isEmpty)
                        ...
                        ...daySessions.map((s) {
                          final t = TimeOfDay(hour: s['hour'] as int, minute: s['minute'] as int);
                          return Container(
